...
;(function ($, window, undefined)
{
    ...
    */
    ...
    Grid.defaults = {
        ...
        labels: {
            all: "Todos",
            infos: "Mostrando {{ctx.start}} to {{ctx.end}} of {{ctx.total}} entries",
            loading: "Carregando...",
        ...
        templates: {
            ...
            header: "<div id=\"{{ctx.id}}\" class=\"{{css.header}}\"><div class=\"row\"><div class=\"col-sm-12 col-md-12 col-lg-12 actionBar\"><p class=\"{{css.search}}\"></p><p class=\"{{css.actions}}\"></p></div></div></div>",
